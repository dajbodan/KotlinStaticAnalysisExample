...
internal fun const(v: Val): Expr.Const = Expr.Const(v)
...
internal fun Node.assertAssignConst(expectedValue: Val) {
...
internal fun Node.assertCondConst(expectedValue: Val) {
    when (this) {
